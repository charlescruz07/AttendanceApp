...
public class studentMessagesRecycler extends RecyclerView.Adapter<studentMessagesRecycler.ViewHolder> {

    private Context mContext;
    private List<studentMessagesModel> studentMessages;
    private StudentActivity studentActivity;

    public studentMessagesRecycler(Context mContext, List<studentMessagesModel> studentMessages, StudentActivity studentActivity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        studentMessagesRecycler.ViewHolder vh = new studentMessagesRecycler.ViewHolder(view);
        return vh;
    }
